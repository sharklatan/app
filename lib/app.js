...
var app = new Framework7({
	...
	routes: [{
		...
		pageInit: function (event, page) {
                ...
                //el código de adsense.
		console.log();
		document.write('<ins class="adsbygoogle ads-colonne-responsive" style="margin:auto;display:block" data-full-width-responsive="true" data-ad-client="ca-pub-9711678720152957" data-ad-slot="9034596816"></ins>');
